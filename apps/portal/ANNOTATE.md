...
shuvplan can annotate any markdown file, not just plans generated by `ExitPlanMode`. This lets users open a markdown document in the annotation UI, mark it up with structured feedback, and send that feedback back to the agent session.
