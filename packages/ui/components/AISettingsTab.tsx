    ...
    return (
      <>
        ...
        <div className="flex items-start gap-2 p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg text-xs text-amber-600 dark:text-amber-400">
          ...
          <span>No AI providers detected. Install the <strong>claude</strong> or <strong>codex</strong> CLI and make sure you're authenticated. <a href="https://plan.shuv.dev/docs/guides/ai-features/" target="_blank" rel="noopener noreferrer" className="underline hover:text-amber-700 dark:hover:text-amber-300">Setup guide</a></span>
        </div>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <div className="text-[10px] text-muted-foreground/70">
        Providers are detected from installed CLI tools. No API keys are managed by shuvplan — you must be authenticated with each CLI independently.{' '}
        <a href="https://plan.shuv.dev/docs/guides/ai-features/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Learn more</a>
      </div>
    </>
  );
};
